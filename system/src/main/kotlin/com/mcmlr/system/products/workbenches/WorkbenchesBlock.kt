...
class WorkbenchesViewController(
    ...
    override fun createView() {
        ...
        val title = addTextView(
            ...
            text = "${ChatColor.BOLD}${ChatColor.ITALIC}${ChatColor.UNDERLINE}Workbenches",
            size = 16,
        )
    }
...
interface WorkbenchesPresenter: Presenter {

}

class WorkbenchesInteractor(
    private val player: Player,
    private val presenter: WorkbenchesPresenter,
): Interactor(presenter) {
    override fun onCreate() {
        super.onCreate()

//        MenuType.ANVIL.create(player, "Crafting Table")
    }
}
